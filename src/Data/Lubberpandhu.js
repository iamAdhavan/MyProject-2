...
import HeaderLubberpandhu from "./HeaderLubberpandhu";
import VideoLubberpandhu from "./VideoLubberpandhu";
...
const Lubberpandhu = () => {
  ...
  return (
    ...
    <div className="item-content-wraper1">
      <div className="item-content-title "> LUBBER PANDHU </div>
      <div className="movie-title"> LUBBER PANDHU </div>
