...
import HeaderMeiyazhagan from "./HeaderMeiyazhagan";
import VideoMeiyazhagan from "./VideoMeiyazhagan";
...
const Meiyazhagan = () => {
  ...
  return (
    ...
    <div className="item-content-wraper1">
      <div className="item-content-title "> MEIYAZHAGAN </div>
      <div className="movie-title"> MEIYAZHAGAN </div>
